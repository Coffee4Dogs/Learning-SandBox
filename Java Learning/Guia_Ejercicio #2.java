...
public class main {
    ...
    public static void main(String[] args) {
        ...
        /* 
         * 2. Dada la cantidad de billetes de cada denominación,
         * haga un programa que calcule e imprima la cantidad total.
         */
        ...
        System.out.println("Cantidad Total: " + cuenta);
        System.out.println("Distribuido en billetes: ");
        ...
        // Calcular el total de billetes

        int total_billetes = billetes_tengo[0] + billetes_tengo[1] + billetes_tengo[2] + billetes_tengo[3]
                + billetes_tengo[4]
                + billetes_tengo[5] + billetes_tengo[6] + billetes_tengo[7] + billetes_tengo[8];
        System.out.println("Cantidad total de billetes: " + total_billetes);
