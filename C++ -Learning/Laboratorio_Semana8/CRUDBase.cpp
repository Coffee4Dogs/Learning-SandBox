            ...
            case 1:
                {
                    ...
                    DatosCliente CNuevo(cCuenta, cNombre, cSaldo);
            ...
            case 2:
                {
                    ...
                    DatosCliente CLeer(888, "YYY", 0.00);
                    ...
                    while (ArchivoClientes100 && !ArchivoClientes100.eof()) {
                        if(CLeer.getCuenta() != 9999){
                            impresion(CLeer.getCuenta(), CLeer.getNombre(), CLeer.getSaldo());
                        }
            ...
            case 3:
                {
                    ...
                    if (CCons.getCuenta() != 9999){
                        ...
                        impresion(CCons.getCuenta(), CCons.getNombre(), CCons.getSaldo());
                    }
                    else{
